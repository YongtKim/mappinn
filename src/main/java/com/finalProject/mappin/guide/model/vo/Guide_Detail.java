...
public class Guide_Detail {
	...
	public Guide_Detail(int package_id, Date package_date, int package_start, int package_end, int content_id,
			int content_type) {
		super();
	...
	public String toString() {
		return "Guide_Detail [package_id=" + package_id + ", package_date=" + package_date + ", package_start="
				+ package_start + ", package_end=" + package_end + ", content_id=" + content_id + ", content_type="
				+ content_type + "]";
	}
